              ...
              this.props.children ||
                <View style={styles.container}>
                  <View style={styles.contHeader}>
                    <Text style={styleTxtTitle}>{isError ? I18n.t('common_dialog_error_title') : I18n.t('common_dialog_success_title')}</Text>
                  </View>
                  ...
                  <View style={styles.contFooter}>
                    <TouchableOpacity onPress={onPress}>
                      <View style={styles.btn}>
                        <Text style={styles.txtButton}>{I18n.t('common_dialog_button_goback')}</Text>
                      </View>
                    </TouchableOpacity>
                  </View>
                </View>
